    ...
    getNavDesktop(){
      ...
      getNavPhoneUI(){
        let style={
            ...
            top: {
                navContainer: {bottom: "0", left: "0", flexDirection: "row", width: "100%", height: "71px", display:"flex", position: "fixed"},
                sectionsContainer: {display:"flex", flexDirection:"row", height:"100%", width:"100%"},
                ...
                navItem: {textDecoration:'none', fontSize: "14px", fontFamily: "'Inter', sans-serif", fontWeight: "500", letterSpacing: "0em", color:"#4B5563", paddingLeft: "11px", paddingRight: "11px"},
                activeNavItem:{textDecoration:'none', fontSize: "14px", fontFamily: "'Inter', sans-serif", fontWeight: "700", color:"#4B5563", paddingLeft: "11px", paddingRight: "11px"},
                linksWrapper: {display: "flex", flexDirection: "row", alignItems: "center", justifyContent:"center", backgroundColor:"#FEFEFE"},
