    ...
    render() {
        ...
        return (
            <div style={{width:"100%", height:"100%", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
                <div style={{...styles.tallCard, display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", }}>
                <div style={{width:"fit-content", height: "fit-content", marginLeft:"1vw", marginTop:"1vh",fontSize:"2.3vh", pointer:"cursor", userSelect:"none"}} 
      ...
      <div style={{marginTop:"20px"}}>
                                    <div style={{ height: "3.2vh", color: "#F0F2EF", width: "11vw", marginBottom:"2vh", background: styles.colorPalette.color5, borderRadius:"7px", justifyContent:"center", alignItems:"center", display:"flex" }} onClick={this.handleLogin} >
             ...
             <div style={{width:"fit-content", height: "fit-content", marginLeft:"1vw", marginTop:"1vh", textDecoration:"underline", fontSize:"2.3vh", pointer:"cursor", userSelect:"none"}} 
                >
                    Have an account? <div onClick={this.props.app.dispatch.bind(this,{register:false})} style={{color:"blue"}}>Login</div>
                </div>
            </div></div>
        );
    }
